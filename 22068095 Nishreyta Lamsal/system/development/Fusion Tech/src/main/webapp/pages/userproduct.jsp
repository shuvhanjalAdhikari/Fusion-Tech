				...
				<div class="featureproductbox">
					...
					<div class="productfeaturetextcontainer">
						<div class="productfeaturetext">
							<strong>${product.product_name}</strong> <span>$${product.price}</span>
						</div>
						<div class="cart-like">
						<form method="post" action="${ pageContext.request.contextPath }/addToCart?productId=${product.product_id}">
						<button class="icon-btn" type="submit"><i class="fa-solid fa-cart-shopping"></i></button>
						</form>
						</div>
					</div>
				</div>
